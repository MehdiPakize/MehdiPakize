...
var userNumber1 = +prompt("Please Enter your Number",1,2,3,4)
var userNumber2 = +prompt("Please Enter your Number",1,2,3,4)
if (userNumber1 == num1 * num2 && userNumber2 == 2) {
alert("Your Answer is: "+ userNumber1)
}else{
    alert("Please Try again")
}